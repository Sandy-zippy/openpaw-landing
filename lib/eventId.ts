...
// Ported from /Users/sandy/pawme-landing/lib/eventId.ts (verbatim — pixel/UTM
// logic is not brand-specific). Only the localStorage UTM key is namespaced
// per-project so OpenPaw and PawMe don't collide if they ever share a domain.

const UTM_STORAGE_KEY = "openpaw_utm";
